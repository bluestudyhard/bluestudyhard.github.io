...
create procedure update_course(in coursenum char(10), in stutype varchar(255), in val varchar(255))
begin
...
create procedure update_score(in stunum char(15), in coursenum char(15), in stutype varchar(255), in val varchar(255))
begin
    if(stutype = 'score')then
        update stuxskc
        set score = val
        where stuxskc.number = stunum and stuxskc.courseNum = coursenum;
    end if;
end;
